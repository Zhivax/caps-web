      ...
      <div className="flex justify-end gap-2">
        ...
        {isUMKM && req.status === RequestStatus.SHIPPED && (
          <button 
            ...
            className="p-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 shadow-md active:scale-95"
          >
...
export const History: React.FC = () => {
  ...
  return (
    <div className="space-y-6 h-full flex flex-col animate-in fade-in duration-500">
      ...
      <ViewportAware placeholderHeight="500px" className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden flex flex-col h-[600px]">
